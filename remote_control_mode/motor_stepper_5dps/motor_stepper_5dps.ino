...
#define V_P5_3 0x00 
#define V_P5_4 0x00 
#define V_P5_checksum 0xF5 

#define V_N5_1 0x0C 
#define V_N5_2 0xFE 
#define V_N5_3 0xFF 
#define V_N5_4 0xFF  
#define V_N5_checksum 0x08 

#define V_P2_1 0xC8  
#define V_P2_2 0x00 
#define V_P2_3 0x00 
#define V_P2_4 0x00 
#define V_P2_checksum 0xC8 

#define V_N2_1 0x38 
#define V_N2_2 0xFF 
#define V_N2_3 0xFF 
#define V_N2_4 0xFF 
#define V_N2_checksum 0x35
...
unsigned char CMD1_V_P5[10]={header_H,V_CMD,device1_Addr,V_data_Length,V_header_checksum1,
                             V_P5_1,V_P5_2,V_P5_3,V_P5_4,V_P5_checksum}; 
                            
unsigned char CMD2_V_P5[10]={header_H,V_CMD,device2_Addr,V_data_Length,V_header_checksum2,
                             V_P5_1,V_P5_2,V_P5_3,V_P5_4,V_P5_checksum}; 

unsigned char CMD1_V_N5[10]={header_H,V_CMD,device1_Addr,V_data_Length,V_header_checksum1,
                             V_N5_1,V_N5_2,V_N5_3,V_N5_4,V_N5_checksum}; 

unsigned char CMD2_V_N5[10]={header_H,V_CMD,device2_Addr,V_data_Length,V_header_checksum2,
                             V_N5_1,V_N5_2,V_N5_3,V_N5_4,V_N5_checksum};
                             

unsigned char CMD1_V_P2[10]={header_H,V_CMD,device1_Addr,V_data_Length,V_header_checksum1,
                             V_P2_1,V_P2_2,V_P2_3,V_P2_4,V_P2_checksum}; 
                          
unsigned char CMD2_V_P2[10]={header_H,V_CMD,device2_Addr,V_data_Length,V_header_checksum2,
                             V_P2_1,V_P2_2,V_P2_3,V_P2_4,V_P2_checksum}; 

unsigned char CMD1_V_N2[10]={header_H,V_CMD,device1_Addr,V_data_Length,V_header_checksum1,
                             V_N2_1,V_N2_2,V_N2_3,V_N2_4,V_N2_checksum}; 

unsigned char CMD2_V_N2[10]={header_H,V_CMD,device2_Addr,V_data_Length,V_header_checksum2,
                             V_N2_1,V_N2_2,V_N2_3,V_N2_4,V_N2_checksum};
