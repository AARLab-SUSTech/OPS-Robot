...
void loop() {
 ...
 if ( myDFRobotBLEGamepad.available() ) {
    ...
    **/
    ...
    /*****************************************************/
    if (buttonState[SWITCH_LEFT_F2] == PRESSED)
    {
        if (joystickRightX > 150 || (joystickRightX < 100 && joystickRightX > 0))
        {
              if(joystickRightX - last_joystickRightX >= 10)
              {
                  for(i=0;i<10;i++)
                  {
                    Serial.write(CMD2_V_N20[i]); 
                  }
                  delay(10);
        ...
        if  (joystickRightY > 150 || (joystickRightY < 100 && joystickRightY   > 0))
        {
              if(joystickRightY - last_joystickRightY >= 10)
              {
                  for(i=0;i<10;i++)
                  {
                    Serial.write(CMD1_V_N20[i]); 
                  }
                  delay(10);
        ...
        if  ((joystickRightX > 100 && joystickRightX < 150) && (joystickRightY > 100 && joystickRightY < 150))
        {
                for(i=0;i<10;i++)
                {
                  Serial.write(CMD2_V_0[i]); 
    ...
    if ( buttonState[SWITCH_LEFT_F2] == RELEASED || ((joystickRightX > 100 && joystickRightX < 150) && (joystickRightY > 100 && joystickRightY < 150)))    
    {
    ...
    if (joystickLeftY > 150 && buttonState[SWITCH_LEFT_F1] == RELEASED)
    {
        Serial3.print("e");  
    }

    if (joystickLeftY > 0 && joystickLeftY < 100 && buttonState[SWITCH_LEFT_F1] == RELEASED)
    {
        Serial3.print("f");  
    }

    if (joystickLeftY > 150 && buttonState[SWITCH_LEFT_F1] == PRESSED)
    {
        Serial3.print("m");  
    }

    if (joystickLeftY > 0 && joystickLeftY < 100 && buttonState[SWITCH_LEFT_F1] == PRESSED)
    {
        Serial3.print("n");  
    }
